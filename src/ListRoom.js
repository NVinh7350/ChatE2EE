...
const obj = {
    userName: 'Favorite',
    uri: require('../images/image_heart.png'),
    ...
    return (
        <View style={ styles.header }>
            <View style={ styles.searchInput }>
                <Image 
                    style={ styles.icon }
                    source={ require('../images/icon_magnifying_glass.png') }
                ></Image>
                <TextInput
...
const itemFavorite = (item, {navigation}) => {
        ...
        <View style={ styles.itemFavorite }>
            <TouchableOpacity >
                <Image 
                    ...
                    source={ require('../images/image_heart.png')}>
                </Image>
    ...
    return (<View style={ styles.itemFavorite }>
        <TouchableOpacity onPress={ () => {console.log('clicka');navigation.navigate('Login')}}>
            <Image 
                style={[ styles.imageFrameLarge, {alignSelf: 'center'} ]}
                source={{uri: item.uri}}>
            </Image>
